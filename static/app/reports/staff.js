...
$(function() {
  ...
  $('#rptpreview').on('click', function() {
    ...
    if(! branch_id) {
      report_url = '{{rpt_server}}frameset?__report=salestaff_all.rptdesign' + opts + params;
    } else {
      params = params + '&branch_id=' + branch_id;
      report_url = '{{rpt_server}}frameset?__report=salestaff_by_branch.rptdesign' + opts + params;
    }
